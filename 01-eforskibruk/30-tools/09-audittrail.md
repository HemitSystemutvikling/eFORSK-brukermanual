...
Databaseansvarlig har muliget til å eksportere revisjonsloggen ved studieslutt og det må gjøres èn eksport for hver skjematype. Eksporten er tilgjengelig under **Verktøy** - **Eksporter revisjonslogg**. Forskningsobjekt-ID i revisjonsloggen kan kobles til **ForskningsobjektUnikNokkel** i data- og samtykkeeksport. 
