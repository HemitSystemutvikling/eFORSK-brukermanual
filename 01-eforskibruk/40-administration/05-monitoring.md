...
Etter skjemautfylling får monitor opp skjemaet til gjennomgang på sin arbeidsliste. Her er det også mulighet for å legge inn kommentarer, queries, dersom monitor oppdager mangelfull, inkonsistent eller uklar dataregistrering og vil følge opp dette på en oversiktlig måte. Queriesoversikt kan eksporteres i pdf-format.
